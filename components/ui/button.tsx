...
>(({ className, children, ...props }, ref) => {
  return (
    <div className={cn("relative rounded-[30px]", className)}>
      <GlowingEffect
        spread={40}
        glow={true}
        disabled={false}
      ...
      <button
        className={cn(
          "group relative flex h-[50px] w-full items-center justify-center overflow-hidden rounded-[30px] border-none z-10",
          "cursor-pointer bg-white shadow-[8px_8px_0px_rgba(255,255,255,0.2)] transition-all duration-300 ease-in-out",
          "hover:translate-y-[5px] hover:shadow-[3px_3px_0px_rgba(255,255,255,0.4)]",
      ...
      >
        ...
        >
          ...
          <path fill="#3b82f6" d="M1006.72,744.28c2.81,143.23-110.17,257.35-247.42,261.9C613.15,1011,498.22,895.93,493.71,758.88,488.93,613.71,603,498,740.69,493.28,886.73,488.24,1004,603.87,1006.72,744.28Z" transform="translate(-202.29 -201.89)"/>
        ...
        <span className="z-10 font-bold text-black font-syncopate transition-colors duration-300 group-hover:text-transparent text-[0.75rem] tracking-[0.2em] uppercase">
          {children}
        </span>
      </button>
    </div>
